...
var userDashboard = (function () {
    function userDashboard(service) {
        this.service = service;
    }
    userDashboard.prototype.ngOnInit = function () {
        this.loggedIn = false;
        this.getUser();
    };
    userDashboard.prototype.getUri = function () {
        var _this = this;
        this.service.getUri().then(function (result) {
            _this.loginUri = result.uri;
        });
    };
    userDashboard.prototype.getUser = function () {
        var _this = this;
    ...
    userDashboard.prototype.getUsers = function () {
        var _this = this;
        this.service.getUsers().then(function (result) { return _this.users = result; });
    };
    userDashboard.prototype.selectUser = function (user) {
